...
def visualize_training_progress(train_losses, train_acc, test_losses, test_acc):
  """ Plots training and testing losses and accuracy curve.
  Args:
    train_losses  : A list of training losses.
    train_acc     : A list of training Accuracy.
    test_losses.  : A list of testing losses.
    test_accuracy : A list of test_accuracy.
...
def display_images(data_loader, image_count=60):
...
def display_misclassified_images(model, model_path, data_loader, class_labels, image_count):
  """Displays a specified number of misclassified images.
